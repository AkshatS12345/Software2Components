...
For my component library design, I chose to make a bank account system with transactions like deposits and withdrawals. I picked this idea because it is easy to understand and relates to the real world. A bank account is a simple example of how to store and change data. It also allows for useful features like keeping track of how much money is in the account and saving a history of what happened. Each transaction, like a deposit or withdrawal, can be saved with the amount and time it happened. This design is clear and easy to separate into parts. It also lets me practice using important ideas from class, like abstraction, contracts, and data organization. In the future, I could add more features like transfers or different types of accounts. Overall, this idea is simple, useful, and a good way to show what I’ve learned.
